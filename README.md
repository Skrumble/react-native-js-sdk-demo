The react-native-js-sdk demo demonstrates the abilities of the JS-SDK on a react-native application. This project was bootstrapped with [Create React Native App](https://github.com/react-community/create-react-native-app).
